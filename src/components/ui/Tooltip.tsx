    ...
    return (
        <Tooltip content={text} side={side} widthClass={widthClass}>
            <button
                type="button"
                aria-label={label}
                className={`inline-flex items-center justify-center text-neutral-400 hover:text-neutral-600 focus-visible:text-neutral-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-primary-500 rounded-full transition-colors ${className}`}
            >
