...
/**
 * Social platform brand colours — source of truth (documentation only).
 * Hover backgrounds are applied via static Tailwind arbitrary-value classes so
 * JIT resolves them at build time. Do NOT switch to JS inline-style handlers —
 * static classes are correctly resolved by Tailwind JIT and preserve keyboard
 * focus behaviour.
