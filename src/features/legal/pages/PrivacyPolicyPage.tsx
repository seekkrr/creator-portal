          ...
          <div className="p-8 sm:p-12 space-y-8 text-neutral-800 leading-relaxed">
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  <span className="font-semibold">Account</span> means a unique account created for
                ...
                <li>
                  <span className="font-semibold">Application</span> refers to SeekKrr, the software
                  program provided by the Company.
                </li>
                <li>
                  <span className="font-semibold">Company</span> (referred to as either "the
                  Company", "We", "Us" or "Our" in this Agreement) refers to SOLOQUEST PRIVATE
                  LIMITED, HIG-29A, Kaushambi Kunj, Kalindipuram, Rajrooppur, Allahabad.
                </li>
                <li>
                  <span className="font-semibold">Cookies</span> are small files that are placed on
                ...
                <li>
                  <span className="font-semibold">Personal Data</span> is any information that
                  relates to an identified or identifiable individual.
                </li>
                <li>
                  <span className="font-semibold">Service</span> refers to the Application or the
                  Website or both.
                </li>
                <li>
                  <span className="font-semibold">Service Provider</span> means any natural or legal
                ...
                <li>
                  <span className="font-semibold">Usage Data</span> refers to data collected
                  automatically, either generated by the use of the Service or from the Service
                  infrastructure itself (for example, the duration of a page visit).
                </li>
                <li>
                  <span className="font-semibold">Website</span> refers to SeekKrr, accessible from{" "}
                  <a
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2 mb-4">
                <li>
                  <span className="font-semibold">Cookies or Browser Cookies.</span> A cookie is a
                ...
                <li>
                  <span className="font-semibold">Web Beacons.</span> Certain sections of our
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2 mb-4">
                <li>
                  <span className="font-semibold">To provide and maintain our Service</span>,
                  including to monitor the usage of our Service.
                </li>
                <li>
                  <span className="font-semibold">To manage Your Account:</span> to manage Your
                ...
                <li>
                  <span className="font-semibold">For the performance of a contract:</span> the
                ...
                <li>
                  <span className="font-semibold">To contact You:</span> To contact You by email,
                ...
                <li>
                  <span className="font-semibold">To provide You</span> with news, special offers,
                  and general information about other goods, services and events which We offer that
                  are similar to those that you have already purchased or inquired about unless You
                  have opted not to receive such information.
                </li>
                <li>
                  <span className="font-semibold">To manage Your requests:</span> To attend and
                  manage Your requests to Us.
                </li>
                <li>
                  <span className="font-semibold">For business transfers:</span> We may use Your
                ...
                <li>
                  <span className="font-semibold">For other purposes:</span> We may use Your
              ...
              <ul className="list-disc pl-6 space-y-2 mb-4">
                ...
                <li>
                  <span className="font-semibold">For business transfers:</span> We may share or
                ...
                <li>
                  <span className="font-semibold">With Affiliates:</span> We may share Your
                ...
                <li>
                  <span className="font-semibold">With Your consent:</span> We may disclose Your
